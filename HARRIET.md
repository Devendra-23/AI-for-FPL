...
4.  **RANK TRACKING:** Always check current overall rank and live rank at https://www.livefpl.net/rank.
5.  **TRANSFER INSIDER CHECK:** During Jan 2026, ALWAYS check Fabrizio Romano, Ben Jacobs, and David Ornstein for confirmed transfers.
6.  **AFCON 2026 AVAILABILITY:** Until Jan 18, 2026, ALWAYS verify if a player is participating in AFCON (e.g., Salah, Mbeumo).
...
## 🏆 The "Veteran Hunter" Strategy (GW21-25)
**Philosophy:** "Mirror & Block". 
When leading against a Veteran manager (ID 1618354), you do not win by being "different". You win by preventing them from being different to you.

### 🕵️ Rival Profile: 1618354
*   **Rank History:** 13k, 37k, 45k. This is an elite manager.
...
1.  **Block the Veteran:** Always check if Rival 1618354 has made a "surge" move.
2.  **Save the Wildcard:** Use it only when the Veteran does, or during a Double GW.
3.  **Stay Templated:** You are 1st. The burden of risk is on the rivals, not you.
