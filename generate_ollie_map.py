...
OUTPUT_IMAGE = 'Ollie_Season_Tactical_Map.png'

# Ollie's Player IDs (Verified from API GW26)
OLLIE_IDS = [1, 411, 8, 5, 449, 82, 237, 47, 329, 430, 249, 470, 317, 441, 252]
...
def main():
    ...
    plt.title("OLLIE: SEASON TACTICAL MAP\nCurrent Squad Performance (GW26)", 
    ...
    print(f"Ollie Map Generated: {OUTPUT_IMAGE}")
